...
public class ActeurRepositoryTest {
	...
	public void testExtraireRealisateursParActeur() {
		TypedQuery<Realisateur> query = em.createQuery("SELECT r FROM Realisateur r JOIN r.films f JOIN f.roles role JOIN role.acteur a WHERE a.identite = 'Brad Pitt'", Realisateur.class);
